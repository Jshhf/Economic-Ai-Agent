...
2. 打开 [http://127.0.0.1:8000/](http://127.0.0.1:8000/)
3. 上传 `data/Employment - City - Weekly.csv`
4. 系统会自动创建分析任务，并进入任务详情页
5. 任务完成后，可以看到：
   - 中文经济分析报告
   - 3 类图表
   - Agent Runs
...
![Upload Page](docs/images/homepage.png)

### Job Detail And Trace

![Job Detail](docs/images/job-detail-complete.png)

### Final Report

![Final Report](docs/images/report-page-complete.png)
